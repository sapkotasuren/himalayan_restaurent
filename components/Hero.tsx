      ...
      <main className="relative min-h-[170vh] w-full mx-auto overflow-hidden">
        ...
        <div className="relative h-screen w-full max-w-screen-lg mx-auto flex flex-col justify-center items-center text-white px-6 sm:px-8 py-24 gap-y-8">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-amber-400 text-sm tracking-[0.3em] uppercase font-light">Premium Dining</span>
...
Nepalese Cuisine,  <br/>       
          ...
          <div className="absolute bottom-12 left-1/2 transform -translate-x-1/2 flex flex-col items-center gap-2 animate-bounce" style={{ animationDuration: '2s' }}>
